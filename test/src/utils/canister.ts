...
import type * as icpLedgerTypes from "@dfinity/ledger-icp/dist/candid/ledger";
import * as icpLedger from "./ledger.idl";
...
export type icpLedgerService = icpLedgerTypes._SERVICE;
