...
import { managementActor } from "./pocket-ic";
import { createHash } from "crypto";

export const PROVISION_CANISTER_WASM = path.resolve('.dfx', 'local', 'canisters', 'provision', 'provision.wasm.gz');
export const ASSET_PROXY_CANISTER_WASM = path.resolve('.dfx', 'local', 'canisters', 'asset_proxy', 'asset_proxy.wasm.gz');
export const TOKEN_CANISTER_WASM = path.resolve('.dfx', 'local', 'canisters', 'estate_dao_nft', 'estate_dao_nft.wasm.gz');
export const ASSET_CANISTER_WASM = path.resolve('.dfx', 'local', 'canisters', 'asset', 'asset.wasm.gz');
